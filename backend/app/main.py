...
from app.models.events import BatteryTelemetry, EmergencyStopRequest
from app.mqtt.client import MQTTService
from app.mqtt.topics import ROBOT_BATTERY_TOPIC, ROBOT_EMERGENCY_TOPIC
...
def create_app() -> FastAPI:
    ...
    safety_service = SafetyService(state_store=robot_state, mqtt_service=mqtt_service)
