...
#
# Usage:
#   ./setup/install_microros_service.sh [ROBOT_IP]
#   ./setup/install_microros_service.sh 10.10.220.142 --uninstall
#
# Env overrides:
#   ROBOT_USER=jetson
...
echo
echo "To roll back:"
echo "  ./setup/install_microros_service.sh $ROBOT_HOST --uninstall"
